      ...
      <section className={styles.introSection}>
        <div className={styles.textContent}>
          ...
          <p>
            ...
            <strong>
              aider votre entreprise à se développer sur le web en vous offrant
              une présence en ligne unique et impactante
            </strong>
            . Que vous soyez une startup ambitieuse ou une entreprise établie,
            nous vous apportons les outils nécessaires pour réussir dans un
      ...
      <section className={styles.servicesSection}>
        ...
        <div className={styles.serviceItems}>
          <div className={styles.serviceItem}>
            ...
            <p>
              Nous concevons des sites internet sur mesure, en prenant en compte
              vos objectifs, vos valeurs et votre audience. Chaque projet est un
              nouveau défi pour créer une expérience utilisateur fluide et une
      ...
      <section className={styles.whyChooseUs}>
        ...
        <div className={styles.whyChooseItems}>
          <div className={styles.whyItem}>
            ...
            <p>
              Notre équipe combine compétences techniques et créativité pour
              vous offrir des solutions modernes et adaptées aux exigences du
              marché.
            </p>
          </div>
          <div className={styles.whyItem}>
            ...
            <p>
              Chaque projet est unique. Nous écoutons attentivement vos besoins
              et mettons en place des solutions sur mesure pour vous garantir
